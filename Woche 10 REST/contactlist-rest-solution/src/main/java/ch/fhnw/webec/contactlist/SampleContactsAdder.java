...
public class SampleContactsAdder implements CommandLineRunner {
	...
	public SampleContactsAdder(ObjectMapper mapper, ContactService contactService) {
		this.mapper = mapper;
	...
	public void addSampleContacts() throws IOException {
		if (!contactService.getContactList().isEmpty()) return;
	...
	public static List<Contact> loadSampleContacts(ObjectMapper mapper) throws IOException {
		return mapper.readValue(SampleContactsAdder.class.getResource(JSON_FILE), new TypeReference<>() {});
	}
}
